					...
					<div id="main">
						...
						<!-- About -->
							<article id="about">
								...
								<span class="image main"><img src="/fassets/images/pic03.jpg" alt="" /></span>
...
print 'It took ' + i + ' iterations to sort the deck.';</code></pre>
		...
		<!-- Scripts -->
			...
			<script src="/fassets/js/browser.min.js"></script>
			<script src="/fassets/js/breakpoints.min.js"></script>
			<script src="/fassets/js/util.js"></script>
